...
// Simple CUDA kernel to convert to grayscale
//
// Alternatively, three kernels can multiply the three single-color "matrices" independetly
// and a fourth kernel can sum the three together in the single output matrix
